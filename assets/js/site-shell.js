...
(()=>{
  ...
  .header-motif{position:absolute;display:block;color:rgba(185,111,151,.19);font-family:Georgia,'Times New Roman',serif;font-weight:700;line-height:1;text-shadow:0 0 20px rgba(235,175,204,.25);animation:ewaHeaderDrift var(--dur,13s) ease-in-out infinite alternate;transform:translate3d(0,0,0) rotate(var(--rot,0deg));will-change:transform,opacity}
  .header-motif.m1{left:3%;top:18%;font-size:1.55rem;--dur:10s;--rot:-12deg}.header-motif.m2{left:25%;top:55%;font-size:1.55rem;--dur:14s;--rot:8deg}.header-motif.m3{left:43%;top:16%;font-size:1.2rem;--dur:12s}.header-motif.m4{left:58%;top:52%;font-size:1.45rem;--dur:16s;--rot:-7deg}.header-motif.m5{left:72%;top:15%;font-size:1.15rem;--dur:11s;letter-spacing:.05em}.header-motif.m6{left:84%;top:58%;font-size:1.45rem;--dur:15s;--rot:9deg}.header-motif.m7{left:35%;top:8%;font-size:1rem;letter-spacing:.26em;--dur:17s}.header-motif.m8{left:66%;top:68%;font-size:1.5rem;--dur:13s;font-style:italic}
  @keyframes ewaHeaderGlow{0%{background-position:0% 45%}100%{background-position:100% 55%}}
  @keyframes ewaHeaderDrift{0%{opacity:.3;transform:translate3d(-7px,-3px,0) rotate(var(--rot,0deg)) scale(.94)}55%{opacity:.68}100%{opacity:.4;transform:translate3d(11px,7px,0) rotate(calc(var(--rot,0deg) + 5deg)) scale(1.08)}}
